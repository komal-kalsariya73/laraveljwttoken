                                                ...
                                                <div class="tab-content pt-4" id="profileTabContent">
                                                    <div class="tab-pane fade show active" id="overview-tab-pane" role="tabpanel" aria-labelledby="overview-tab" tabindex="0">
                                                        ...
                                                        <div id="profileInfo" class="row">
                                                            ...
                                                            <div class="col-7 col-md-9 bg-light border-start border-bottom border-white border-3">
                                                                <div class="p-2">{{ ucfirst($user->gender ?? '') }}</div>
                                                            </div>
                                                    ...
                                                    <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                                        <form action="" class="row gy-3 gy-xxl-4" id="updateProfile" method="POST" data-action="">
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" id="name" name="name" value="{{ $user->name ?? ''}}"> <!-- Use $userInfo -->
                                                                <span id="demo1" class="error-message" style="color:red"></span>
                                                            </div>

                                                            <div class="col-12 col-md-6">
                                                                <label for="inputPhone" class="form-label">Phone</label>
                                                                <input type="number" class="form-control" id="phone" name="phone" value="{{ $user->phone ?? '' }}"> <!-- Use $userInfo -->
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" id="address" name="address" value="{{ $user->address ?? '' }}"> <!-- Use $userInfo -->
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                ...
                                                                <div class="mt-2">
                                                                    ...
                                                                    <img src="{{ asset($user->profile_image) }}" alt="Profile Image" class="img-thumbnail" style="width: 120px; height: 120px; object-fit: cover;">
                                                                    @else
                                                                    <img src="{{ asset('uploads/users/default-profile.jpg') }}" alt="Default Image" class="img-thumbnail" style="width: 120px; height: 120px; object-fit: cover;">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
